...
//Owner General Calendar
$(document).ready(function () {
    var eventListing = GetOwnerData('owner-general');
    ...
    $('#eventcalendar').fullCalendar({
        ...
        events: function (start, end, timezone, callback) {
            var obj = jQuery.parseJSON(eventListing);
            var eventsArr = [];
            for (var i in obj) {
                eventsArr.push({
                    title: obj[i].title,
...
$(document).ready(function () {
    var initialLocaleCode = 'en';
    var eventListingCommonArea = GetOwnerData('owner-commonarea');
